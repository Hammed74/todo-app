...
function addToDom(obj) {
  ...
  const parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(obj.date)
  const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(parsedDate, "eeee - LLL dd, yyyy");
...
function addProjectToDom(obj){
    ...
    deleteButton.src = _assets_close_png__WEBPACK_IMPORTED_MODULE_1__;
...
/* harmony export */   todoInProject: () => (/* binding */ todoInProject)
/* harmony export */ });
/* harmony import */ var _addtodo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addtodo */ "./src/addtodo.js");
  ...
  deleteButton.addEventListener("click", (event) => {
    for (let i = 0; i < _addtodo__WEBPACK_IMPORTED_MODULE_0__.listArray.length; i++) {
      if (_addtodo__WEBPACK_IMPORTED_MODULE_0__.listArray[i] === obj) {
        ...
        localStorage.setItem("todo-array", JSON.stringify(_addtodo__WEBPACK_IMPORTED_MODULE_0__.listArray));
        break;
      }
    }
  });
...
/* harmony import */ var _todoInProject_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./todoInProject.js */ "./src/todoInProject.js");
...
let page = () => {
  ...
  submitBtn.addEventListener("click", (event) => {
    ...
    if (
      ...
      let item = new _addtodo__WEBPACK_IMPORTED_MODULE_1__.ListItem(
        title.value,
        desc.value,
        date.value,
        priority.value,
      ...
      _addtodo__WEBPACK_IMPORTED_MODULE_1__.listArray.push(item);
     ...
     localStorage.setItem("todo-array", JSON.stringify(_addtodo__WEBPACK_IMPORTED_MODULE_1__.listArray));
  });
  ...
  document
    ...
    .addEventListener("click", function (event) {
      if (event.target.classList.contains("project")) {
        ...
        storedListArray.forEach((item, index) => {
         if (item.project === projectId) {
          projectBox.textContent = ""
            ;(0,_todoInProject_js__WEBPACK_IMPORTED_MODULE_4__.todoInProject)(storedListArray[index], projectBox);
        ...
        const deleteButton = document.createElement("img");
        deleteButton.src = _assets_close_png__WEBPACK_IMPORTED_MODULE_3__;
        deleteButton.classList.add("project-delete");
